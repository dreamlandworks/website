...
<head>
        <meta charset="utf-8" />
        <title>Admin Login | Satarango LimitLess</title>
        ...
        <link href="<?=base_url()?>assets/css/pages/login/classic/login-37b4a.css?v=7.1.0" rel="stylesheet" type="text/css" />
    ...
    <body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
        ...
        <div class="d-flex flex-column flex-root">
            ...
            <div class="login login-3 login-signin-on d-flex flex-row-fluid" id="kt_login">
                <div class="d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid" style="background-image: url(<?=base_url()?>assets/media/bg/bg-1.jpg);">
                    <div class="login-form text-center text-white p-7 position-relative overflow-hidden">
                        <!--begin::Login Header-->
                        <div class="d-flex flex-center mb-15">
                            <a href="#">
                                <img src="<?=base_url()?>assets/logo1.png" class="max-h-150px" alt="" />
                            </a>
                        </div>
                        <!--end::Login Header-->
                        ...
                        <div class="login-signin">
                            ...
                            <form onsubmit="return false;" class="form" id="kt_login_signin_form">
                                <div class="form-group">
                                    <input class="form-control h-auto text-white placeholder-white opacity-70 bg-dark-o-70 rounded-pill border-0 py-4 px-8 mb-5" id="username1" type="text" placeholder="Email" name="username" autocomplete="off" required="" />
                                </div>
                                <div class="form-group">
                                    <input class="form-control h-auto text-white placeholder-white opacity-70 bg-dark-o-70 rounded-pill border-0 py-4 px-8 mb-5" id="password1" type="password" placeholder="Password" name="password" required="" />
                                </div>
      ...
      <script type="text/javascript">
        ...
        <script src="<?=base_url()?>assets/js/pages/custom/login/login-general7b4a.js?v=7.1.0"></script>
        <!--end::Page Scripts-->
    </body>
    <!--end::Body-->
</html>