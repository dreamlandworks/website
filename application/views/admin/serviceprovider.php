...
<html lang="en">
   ...
   <head>
      <meta charset="utf-8" />
      <title>Service Provider | Satarango </title>
                        ...
                        <div class="d-flex align-items-center flex-wrap mr-1">
                           ...
                           <div class="d-flex align-items-baseline flex-wrap mr-5">
                              ...
                              <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                                 ...
                                 <li class="breadcrumb-item">
                                    <a href="#" class="text-muted">Service Providers</a>
                                 </li>
                              </ul>
                              <!--end::Breadcrumb-->
                           </div>
                        ...
                        <div class="card card-custom card-stretch gutter-b">
                           ...
                           <div class="card-header border-0 py-5">
                              <h3 class="card-title align-items-start flex-column">
                                 <span class="card-label font-weight-bolder text-dark">Service Providers</span>
                                 <span class="text-muted mt-3 font-weight-bold font-size-sm">More than 40+ new members</span>
                              </h3>
                                    ...
                                    <table class="table table-head-custom table-head-bg table-borderless table-vertical-center" id='example'>
                                       <thead>
                                          <tr class="text-left text-uppercase">
                                             ...
                                             <th style="min-width: 90px">Earning</th>
                                             <th style="min-width: 70px">Wages</th>
                                       ...
                                       <tbody>
                                          <?php $a=1;foreach ($product as $key => $value) { ?>
                                          <tr>
                                             <!-- <td>
                                                <span class="text-dark-75 font-weight-bolder d-block font-size-lg"><?=$a++;?></span>
                                                </td> -->
                                             <td>
                                                <span style="width: 250px;">
                                                   <div class="d-flex align-items-center">
                                                      <div class="symbol symbol-40 symbol-circle symbol-sm">
                                                         <img src="<?=base_url()?>assets/media/users/<?=$value->image?>" style="height:60px;width: 60px;">
                                                      </div>
                                                   </div>
                                                </span>
                                             </td>
                                             <td>
                                                <span class="text-dark-75 font-weight-bolder d-block font-size-lg">$<?=$value->earning;?></span>
                                             </td>
                                             <td>
                                                <span class="text-dark-75 font-weight-bolder d-block font-size-lg">$<?=$value->wages;?></span>
                                             </td>
                                             <td>
                                                <span class="text-dark-75 font-weight-bolder d-block font-size-lg"><?=$value->service_name;?></span>
                                             </td>
                                             <td>
                                                <!-- <span class="text-dark-75 font-weight-bolder d-block font-size-lg"><?=$value->status;?></span> -->
                                                 <?php if($value->status=="0"){ ?>
                                            <a href="<?=base_url('Admin/deactiveserver')?>/<?=$value->id?>"><span class="label label-lg font-weight-bold label-light-danger label-inline">Unapproved </span></a>
                                           <?php  }else{ ?>
                                             <a href="<?=base_url('Admin/activeserver')?>/<?=$value->id?>"><span class="label label-lg font-weight-bold label-light-success label-inline">Approved </span></a>
                                             <?php } ?>
                                        </td>
                                             </td>
                                             <td class="pr-0 ">
                                                <a href="<?=base_url('Admin/providerview')?>/<?=$value->id;?>" class="btn btn-light-success  font-size-sm"><i class="la la-eye"></i> </a>
                                                <a onclick="return confirm('Are you sure want to delete ?');"  href="<?=base_url('Admin/servicedelete')?>/<?=$value->id;?>" class="btn btn-sm btn-clean btn-icon" title="Delete"><i class="la la-trash"></i>
                                             </td>
                                          </tr>
                                          <?php } ?>
                                       </tbody>
