						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="row"> 
								    ...
								    <form class=" form" enctype="" method="post" action="<?=base_url()?>Admin/addFaq">
									 <div class="card-body ">
									  <div class="form-group">
									   <label>Enter Question :</label>
									   <input type="text" name="question" class="form-control form-control-solid" placeholder="Enter Question" required="" />
									
									  </div>
									  <div class="form-group ">
										<label class="col-form-label text-right ">Answer:</label>
										<textarea name="answer" class="summernote" id="kt_summernote_1" required=""></textarea>
									 </div>
									 </div>
