...
<head>
	  <meta charset="utf-8" />
		<title>Update  Sub Category | Satarango </title>
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										...
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item">
												<a href="#" class="text-muted">Sub category</a>
											</li>
												<li class="breadcrumb-item">
												<a href="#" class="text-muted">Update Sub category</a>
											</li>
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="row"> 
								    ...
								    <form class=" form" enctype="multipart/form-data" method="post" action="<?=base_url()?>Admin/updatesub_subcategory/<?=$detail->id?>">
									 <div class="card-body ">
		                      ...
		                      ?>
		                        <?php } ?>
                                 ...
                                 <select name="subcat_id" class="form-control selectpicker">
									  	<option value="">- Select Sub Category Name -</option>
								 <?php foreach ($subcategoryis as $row) {
		                        if($detail->subcat_id == $row->id){ ?>
		                          <option selected value="<?php echo $row->id; ?>"><?php echo $row->name; ?></option>
		                       <?php }else{ ?>
		                          <option value="<?php echo $row->id; ?>"><?php echo $row->name; ?></option>
		                       <?php }
		                      ?>
		                        <?php } ?>
									  ...
									  <div class="form-group">
									   ...
									   <input type="text" name="name" class="form-control form-control-solid" placeholder="Enter Sub category name" required="" value="<?=$detail->name?>" />
									   <span class="form-text text-muted">Please Enter Sub category Name</span>
									  </div>
										...
										<div class="card-body">
                                           <div class="card card-custom card-stretch gutter-b">
											...
											<div class="card-header border-0">
												<h3 class="card-title font-weight-bolder text-dark">Sub Category List</h3>
												...
												<div class="d-flex align-items-center mb-2">
													...
													<div class="symbol symbol-40 symbol-light-success mr-5">
														<span class="symbol-label">
															<!--<img src="<?=base_url()?>assets/media/users/<?=$categori->icon?>" class="h-75 align-self-end" alt="" />-->
														</span>
													</div>
													<!--end::Symbol-->
													<!--begin::Text-->
													<div class="d-flex flex-column flex-grow-1 font-weight-bold">
														...
														<span class="text-muted"><?=$subcategori->subcat_name?></span>
													</div>
													<!--end::Text-->
													<!--begin::Dropdown-->
													<div class="dropdown dropdown-inline ml-2" data-toggle="tooltip" title="Quick actions" data-placement="left">
														...
														<a href="<?=base_url()?>Admin/updatesub_subcategory/<?=$subcategori->id?>" class="btn btn-hover-light-primary btn-sm btn-icon" >
