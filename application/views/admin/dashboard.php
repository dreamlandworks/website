...
<html lang="en">
   ...
   <head>
      ...
      <title>Satarango Limitless</title>
                           ...
                           <div class="col-lg-12 col-xxl-12">
                              ...
                              <div class="card card-custom bg-gray-100 card-stretch gutter-b">
                                 ...
                                 <div class="card-header border-0 bg-danger py-5">
                                    ...
                                    <h3 class="card-title font-weight-bolder text-white">Sales Status</h3>
                                 ...
                                 <div class="card-body p-0 position-relative overflow-hidden">
                                    ...
                                    <div class="card-spacer mt-n25">
                                       ...
                                       <div class="row m-0">
                                          ...
                                          <div class="col-4 bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7">
                                             ...
                                             <a href="#" class="text-warning font-weight-bold font-size-h6">Total Booking</a>

                                          </div>

                                          <div class="col-4 bg-light-primary px-6 py-8 rounded-xl mb-7">
                                             ...
                                             <a href="<?=base_url('Admin/users')?>" class="text-primary font-weight-bold font-size-h6 mt-2">New Users</a>
                                       ...
                                       <div class="row m-0">
                                          ...
                                          <div class="col-4 bg-light-danger px-6 py-8 rounded-xl mr-7">
                                             ...
                                             <a href="<?=base_url('Admin/activejobs')?>" class="text-danger font-weight-bold font-size-h6 mt-2">New Jobs</a>

                                          </div>

                                          <div class="col-4 bg-light-success px-6 py-8 rounded-xl">

                                             <span class="svg-icon svg-icon-3x svg-icon-success d-block my-2">

                                                <!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/Communication/Urgent-mail.svg-->

                                                <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2020-08-25-063451/theme/html/demo1/dist/../src/media/svg/icons/Home/Commode2.svg-->
                                             ...
                                             <a href="<?=base_url('Admin/serviceProvider')?>" class="text-success font-weight-bold font-size-h6 mt-2">Service Providers</a>
