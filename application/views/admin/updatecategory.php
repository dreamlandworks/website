...
<head>
		...
		<meta charset="utf-8" />
		<title>Update Category | Satarango </title>
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										...
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item">
												<a href="#" class="text-muted">Update Category</a>
											</li>
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="row"> 
								    ...
								    <form class=" form" enctype="multipart/form-data" method="post" action="<?=base_url()?>Admin/updatecategory/<?=$detail->id?>">
									 <div class="card-body ">
									  <div class="form-group">
									   <label>Category Name:</label>
									   <input type="text" name="name" class="form-control form-control-solid" placeholder="Enter category name" value="<?=$detail->name?>" required="" />
									...
									<div class="card">
										<div class="card-body">
                                           <div class="card card-custom card-stretch gutter-b">
											...
											<?php  if($category){ foreach($category as $categori){ ?>	
												<!--begin::Item-->
												<div class="d-flex align-items-center mb-2">
													...
													<div class="d-flex flex-column flex-grow-1 font-weight-bold">
														<a href="#" class="text-dark text-hover-primary mb-1 font-size-lg"><?=$categori->name?></a>
															<span class="text-muted" style="width:150px; height:10px; background-color:<?=$categori->bgcolor?>"></span>
													</div>
													<!--end::Text-->
													<!--begin::Dropdown-->
													<div class="dropdown dropdown-inline ml-2" data-toggle="tooltip" title="Quick actions" data-placement="left">
														<a href="<?=base_url()?>Admin/deletecategory/<?=$categori->id?>" onclick="retrun confirm('Are you sure want to delete? ')" class="btn btn-hover-light-primary btn-sm btn-icon" >
															<i class="la la-trash"></i>
														</a>
														<a href="<?=base_url()?>Admin/updatecategory/<?=$categori->id?>" class="btn btn-hover-light-primary btn-sm btn-icon" >
