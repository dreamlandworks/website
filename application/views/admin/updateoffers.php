...
<head>
		...
		<meta charset="utf-8" />
		<title>Update offers | Satarango </title>
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Update Offers</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="row"> 
								    ...
								    <form class=" form" enctype="multipart/form-data" method="post" action="<?=base_url()?>Admin/offerupdate/<?=$offer->id?>">
									 <div class="card-body ">
                                    
                                     <div class="form-group row">
										<label class="col-xl-3 col-lg-3 text-right col-form-label">Banners Image</label>
										<div class="col-lg-9 col-xl-9">
											<div class="image-input image-input-outline image-input-circle" id="kt_user_avatar" style="background-image: url(<?=base_url()?>assets/media/users/<?=$offer->banner?>)">
									...
									<i class="ki ki-bold-close icon-xs text-muted"></i>
									  ...
									  <div class="form-group">
									   <label>Title:</label>
									   <input type="text" name="title" class="form-control form-control-solid" placeholder="Enter offer title" required="" value="<?=$offer->title?>" />
									   </div>
									  <div class="form-group">
									   <label>Code:</label>
									   <input type="text" name="code" class="form-control form-control-solid" placeholder="Enter offer Code" required="" value="<?=$offer->code?>"  />
									  </div>
									  <div class="form-group">
									    <label for="exampleSelects">Select Offer type</label>
									    <!-- <select onchange="offers()" class="form-control form-control-solid" name="offertype" id="exampleSelects" required>
									     ...
									     <select name="offertype" id="exampleSelects"  class="form-control selectpicker" required>
									       
                                          <option <?php if($offer->type=="percentage"): echo " selected " ; endif ?>   value="percentage">Percentage</option>
                                          <option <?php if($offer->type=="Amount"): echo " selected " ; endif ?> value="Amount">Amount</option>
                                       
                                         </select>
									  </div>
									  <div class="form-group" id="amount">
									   <label>Amount:(0.00)</label>
									   <input type="number" name="amount" class="form-control form-control-solid" placeholder="Enter offer Amount" value="<?=$offer->amount?>"  />
									  </div>
                                     <div class="form-group" id="percentage">
									   <label>Percentage:(%)</label>
									   <input type="number" name="percentage" class="form-control form-control-solid" placeholder="Enter offer Percentage" value="<?=$offer->percentage?>"   />
									  </div>
                                      <div class="form-group" id="percentage">
									   <label>Start date:</label>
									   <input type="date" name="start_date" class="form-control form-control-solid" placeholder="Enter start date" required="" value="<?=$offer->start_date?>"  />
									  </div>
									  <div class="form-group" id="percentage">
									   <label>End date:</label>
									   <input type="date" name="end_date" class="form-control form-control-solid" placeholder="Enter end date" required="" value="<?=$offer->end_date?>"  />
									  </div>
									 </div>
