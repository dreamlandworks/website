...
<head>
		...
		<title>Single Move Booking | Satarango </title>
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										...
										<h5 class="text-dark font-weight-bold my-1 mr-5">Booking</h5>
										...
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item">
												...
												<a href="<?=base_url()?>Dashboard" class="text-muted">Home</a>

											</li>

											<li class="breadcrumb-item">

												<a href="#" class="text-muted">Pending Booking</a>
									...
									<div class="card-body">
										...
										<table class="table table-separate table-head-custom table-checkable" id="example1">
											...
											<tbody>
												...
												<?php if($singleMoves){ foreach($singleMoves as $singleMove){ ?>

												<tr>

												    	<td>
												    		<a href="<?=base_url()?>Admin/booking_detail/<?=$singleMove->id;?>">
													  <?=$singleMove->bookingId?>
													</a>
													 </td>

												

												    <td><?=ucfirst($singleMove->fname);?></td>

												    <td><?=$singleMove->from_time?></td>

													<td><?=$singleMove->to_time?></td>

													<td><?=$singleMove->start_location1?></td>
													<td><?=$singleMove->job_status?></td>
													...
													<td>
													    ...
													    <a onclick="return confirm('Are you sure want to delete ?');"  href="<?=base_url('Admin/delete_singleMove_booking')?>/<?=$singleMove->id?>" class="btn btn-sm btn-clean btn-icon" title="Delete"><i class="la la-trash"></i>	</a>

													    <a href="<?=base_url('Admin/booking_detail')?>/<?=$singleMove->id?>" class="btn btn-sm btn-clean btn-icon" title="view"><i class="la la-eye"></i>	</a>
