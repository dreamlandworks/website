...
<head>
		...
		<title>Active Job List | Satarango </title>
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										...
										<h5 class="text-dark font-weight-bold my-1 mr-5">Active Jobs</h5>
										...
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item">
												...
												<a href="#" class="text-muted">Active Jobs</a>

											</li>

											<li class="breadcrumb-item">

												<a href="#" class="text-muted">Active Jobs  List</a>
								...
								<div class="card card-custom">
									...
									<div class="card-header">
										...
										<div class="card-title">
											...
											<h3 class="card-label">Active Job  list</h3>
									...
									<div class="card-body">
										...
										<table class="table table-separate table-head-custom table-checkable" id="example1">
											...
											<tbody>
																	...
																	<?php if($Active_jobs){ foreach($Active_jobs as $Active_job){ ?>
												...
												<tr>
												    ...
												    <td><?=$Active_job->desecration?></td>

												    <td><?=$Active_job->amount?></td>

													<td><?=$Active_job->start_date?></td>

													<td><?=$Active_job->end_date?></td>

													<td>

													  <?php if($Active_job->status=="0"){ ?>

													     <a href="<?=base_url('Admin/deactivepending')?>/<?=$Active_job->id?>"><span class="label label-lg font-weight-bold label-light-danger label-inline">Unapproved </span></a>

													    <?php  }else{ ?>

													      <a href="<?=base_url('Admin/activepending')?>/<?=$Active_job->id?>"><span class="label label-lg font-weight-bold label-light-success label-inline">Approved </span></a>
													...
													<td>	<div class="dropdown dropdown-inline">
													    	...
													    	<div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
													    	 ...
													    	 <a onclick="return confirm('Are you sure want to delete ?');"  href="<?=base_url('Admin/Activedelete')?>/<?=$Active_job->id?>" class="btn btn-sm btn-clean btn-icon" title="Delete"><i class="la la-trash"></i>	</a>

													    	<a href="<?=base_url('Admin/activedetails')?>/<?=$Active_job->id?>" class="btn btn-sm btn-clean btn-icon" title="view"><i class="la la-eye"></i>	</a>
