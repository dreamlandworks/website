...
<head>
	  <meta charset="utf-8" />
		<title>Sub Category | Satarango </title>
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										...
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item">
												<a href="#" class="text-muted"> Subcategory</a>
											</li>
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="row"> 
								    ...
								    <form class=" form" enctype="multipart/form-data" method="post" action="<?=base_url()?>Admin/sub_subcategory">
									 <div class="card-body ">
									   ...
									   <select name="subcat_id" class="form-control selectpicker">
									       <?php if($subscategory){ foreach($subscategory as $value){  ?>
                                          <option value="<?=$value->id?>"><?=$value->name?></option>
                                         <?php  }  } ?>
                                         </select>
									  </div>
										...
										<div class="card-body">
                                           <div class="card card-custom card-stretch gutter-b">
											...
											<div class="card-header border-0">
												<h3 class="card-title font-weight-bolder text-dark"> Subcategory List</h3>
