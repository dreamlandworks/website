...
<head>
		...
		<meta charset="utf-8" />
		<title>Create offers | Satarango </title>
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Create Offers</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item">
												<a href="#" class="text-muted">Create Offers</a>
										    </li>
										</ul>
										<!--end::Breadcrumb-->
									</div>
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="row"> 
								    ...
								    <form class=" form" enctype="multipart/form-data" method="post" action="<?=base_url()?>Admin/createoffers">
									 <div class="card-body ">
									...
									<i class="ki ki-bold-close icon-xs text-muted"></i>
									  ...
									  <div class="form-group">
									   <label>Title:</label>
									   <input type="text" name="title" class="form-control form-control-solid" placeholder="Enter offer title" required="" />
									   </div>
									  <div class="form-group">
									   <label>Code:</label>
									   <input type="text" name="code" class="form-control form-control-solid" placeholder="Enter offer Code" required="" />
									  </div>
									  <div class="form-group">
									    <label for="exampleSelects">Select Offer type</label>
									    <select onchange="offers()" class="form-control form-control-solid" name="offertype" id="exampleSelects">
									  ...
									  <div class="form-group" id="amount">
									   ...
									   <input type="number" name="amount" class="form-control form-control-solid" placeholder="Enter offer Amount" />
									  </div>
                                     <div class="form-group" id="percentage">
									   <label>Percentage:(%)</label>
									   <input type="number" name="percentage" class="form-control form-control-solid" placeholder="Enter offer Percentage"  />
									  </div>
                                      <div class="form-group" id="percentage">
									   <label>Start date:</label>
									   <input type="date" name="start_date" class="form-control form-control-solid" placeholder="Enter start date" required="" />
									  </div>
									  <div class="form-group" id="percentage">
									   <label>End date:</label>
									   <input type="date" name="end_date" class="form-control form-control-solid" placeholder="Enter end date" required="" />
									  </div>
									 </div>
