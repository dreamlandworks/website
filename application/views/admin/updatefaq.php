...
<head>
		...
		<meta charset="utf-8" />
		<title>Update FAQ | Satarango </title>
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">ADD FAQ</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="row"> 
								    ...
								    <form class=" form" enctype="" method="post" action="<?=base_url()?>Admin/updatefaq/<?=$faq->id?>">
									 <div class="card-body ">
									  <div class="form-group">
									   <label>Enter Question :</label>
									   <input type="text" name="question" class="form-control form-control-solid" placeholder="Enter Question" required="" value="<?=$faq->question?>" />
									
									  </div>
									  <div class="form-group ">
										<label class="col-form-label text-right ">Answer:</label>
										<textarea name="answer" class="summernote" id="kt_summernote_1" required=""><?=$faq->answer?></textarea>
									 </div>
									 </div>
		...
		<script src="<?=base_url()?>/assets/js/pages/crud/forms/editors/summernote7b4a.js?v=7.1.0"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->
