									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										...
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item">
												...
												<a href="#" class="text-muted">Reports List</a>
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-3 ">
                              ...
                              <button type="submit" class="btn-primary btn " style="margin-top: 24px;">Search</button>
									...
									<?php if($reports){ foreach($reports as $user){ ?>

												<tr>

												 

													<td style="width : 100px"> <?=$user->fname?></td>

												

												    <td style="width : 100px"><?=$user->email?></td>

													<td style="width : 100px"><?=$user->reason?></td>	
													<td style="width : 100px"><?=$user->date?></td>
