...
<head>
		...
		<meta charset="utf-8" />
		<title>User List | Satarango </title>
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										...
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item">
												<a href="#" class="text-muted">user List</a>
											</li>
												...
												<tr>
													    ...
													    <span style="width: 250px;">
													        <div class="d-flex align-items-center">
													            <div class="symbol symbol-40 symbol-circle symbol-sm">
													               <img class="" src="<?=base_url()?>assets/media/users/300_25.jpg" alt="photo">
													            </div>							
													...
													<td>
													  <?php if($user->status=="0"){ ?>
													     <a href="<?=base_url('Admin/deactiveaccunt')?>/<?=$user->id?>"><span class="label label-lg font-weight-bold label-light-danger label-inline">Dactive</span></a>
													    <?php  }else{ ?>
													      <a href="<?=base_url('Admin/activeaccunt')?>/<?=$user->id?>"><span class="label label-lg font-weight-bold label-light-success label-inline">Active</span></a>
													      <?php } ?>
													 </td>
													<td>	<div class="dropdown dropdown-inline">
													    	<div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
													    	 ...
													    	 <a onclick="return confirm('Are you sure want to delete ?');"  href="<?=base_url('Admin/userdelete')?>/<?=$user->id?>" class="btn btn-sm btn-clean btn-icon" title="Delete"><i class="la la-trash"></i>	</a>
													    	<a href="<?=base_url('Admin/userdetail')?>/<?=$user->id?>" class="btn btn-sm btn-clean btn-icon" title="view"><i class="la la-eye"></i>	</a>
											  	</td>
