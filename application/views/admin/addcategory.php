...
<head>
		...
		<meta charset="utf-8" />
		<title>Main Category | Satarango </title>
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										...
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item">
												<a href="#" class="text-muted">Main Category</a>
											</li>
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="row"> 
								    ...
								    <form class=" form" enctype="multipart/form-data" method="post" action="<?=base_url()?>Admin/addcategory">
									 <div class="card-body ">
									...
									<i class="ki ki-bold-close icon-xs text-muted"></i>
									  ...
									  <div class="form-group">
									   <label> Main Category background color:</label>
										...
										<div class="card-body">
                                           <div class="card card-custom card-stretch gutter-b">
											...
											<div class="card-header border-0">
												<h3 class="card-title font-weight-bolder text-dark">Main Category List</h3>
											...
											<?php  if($category){ foreach($category as $categori){ ?>	
												...
												<div class="d-flex align-items-center mb-2">
													...
													<div class="dropdown dropdown-inline ml-2" data-toggle="tooltip" title="Quick actions" data-placement="left">
														<a href="<?=base_url()?>Admin/deletecategory/<?=$categori->id?>" onclick="return confirm('Are you sure?')" class="btn btn-hover-light-primary btn-sm btn-icon" >
