							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Privacy</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container">
								...
								<div class="row"> 
								    ...
								    <form class=" form" enctype="" method="post" action="<?=base_url()?>Admin/privacy">
									 <div class="card-body ">
									 
									  <div class="form-group ">
										<label class="col-form-label text-right ">Enter Privacy Policy :</label>
										<textarea name="content" class="summernote" id="kt_summernote_1" required=""><?=$privacy->content?></textarea>
									 </div>
									 </div>
