											...
											<div class="card-body pt-4">
												...
												<div class="d-flex align-items-center">
													<div class="symbol symbol-60 symbol-xxl-100 mr-5 align-self-start align-self-xxl-center">
														<div class="symbol-label" style="background-image:url('<?=base_url()?>assets/media/users/300_25.jpg')"></div>
														<i class="symbol-badge bg-success"></i>
													</div>
													<div>
														<a href="#" class="font-weight-bolder font-size-h5 text-dark-75 text-hover-primary"><?=$user->fname.' '.$user->lname?></a>
											...
											<form class="form">
												...
												<div class="card-body">
													...
													<div class="form-group row">
														...
														<div class="col-lg-9 col-xl-6">
															<input class="form-control form-control-lg form-control-solid" type="text" value="<?=$user->fname?>" disabled />
														</div>
													</div>
													<div class="form-group row">
														<label class="col-xl-3 col-lg-3 col-form-label">Last Name</label>
														<div class="col-lg-9 col-xl-6">
															<input class="form-control form-control-lg form-control-solid" type="text" value="<?=$user->lname?>" disabled />
														</div>
													</div>
													 <div class="form-group row">
														<label class="col-xl-3 col-lg-3 col-form-label">Phone</label>
														<div class="col-lg-9 col-xl-6">
															<input class="form-control form-control-lg form-control-solid" type="number" value="<?=$user->phone?>" disabled />
													...
													<div class="form-group row">
														...
														<div class="col-lg-9 col-xl-6">disabled
															<div class="input-group input-group-lg input-group-solid">
																...
																<input type="number" class="form-control form-control-lg form-control-solid" value="<?=$user->phone?>" placeholder="Phone" disabled/>
															</div>
													...
													<div class="form-group row">
														...
														<div class="col-lg-9 col-xl-6">
															<div class="input-group input-group-lg input-group-solid">
																...
																<input type="email" class="form-control form-control-lg form-control-solid" value="<?=$user->email?>" placeholder="Email" disabled/>
															</div>
														</div>
													</div>
													<!-- <div class="form-group row">
