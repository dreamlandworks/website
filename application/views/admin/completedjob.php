...
<head>
		...
		<meta charset="utf-8" />
		<title>Complete Job List | Satarango </title>
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Complete Jobs</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item">
												<a href="#" class="text-muted">Complete Jobs</a>
											</li>
											<li class="breadcrumb-item">
												<a href="#" class="text-muted">Complete Jobs  List</a>
											</li>
								...
								<div class="card card-custom">
									<div class="card-header">
										<div class="card-title">
											...
											<h3 class="card-label">Complete Job  list</h3>
										</div>
									...
									<div class="card-body">
										...
										<table class="table table-separate table-head-custom table-checkable" id="example1">
											...
											<tbody>
																	<?php if($pending_jobs){ foreach($pending_jobs as $pending_job){ ?>
												<tr>
												    	<td>
													  <?=$pending_job->title?>
													 </td>
												
												    <td><?=$pending_job->desecration?></td>
												    <td><?=$pending_job->amount?></td>
													<td><?=$pending_job->start_date?></td>
													<td><?=$pending_job->end_date?></td>
													<td>
													  <?php if($pending_job->status=="0"){ ?>
													     <a href="<?=base_url('Admin/deactivepending')?>/<?=$pending_job->id?>"><span class="label label-lg font-weight-bold label-light-danger label-inline">Unapproved </span></a>
													    <?php  }else{ ?>
													      <a href="<?=base_url('Admin/activepending')?>/<?=$pending_job->id?>"><span class="label label-lg font-weight-bold label-light-success label-inline">Approved </span></a>
													      <?php } ?>
													 </td>
													<td>	<div class="dropdown dropdown-inline">
													    	<div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
													    	 ...
													    	 <a onclick="return confirm('Are you sure want to delete ?');"  href="<?=base_url('Admin/Activedelete')?>/<?=$pending_job->id?>" class="btn btn-sm btn-clean btn-icon" title="Delete"><i class="la la-trash"></i>	</a>
													    	<a href="<?=base_url('Admin/completedetails')?>/<?=$pending_job->id?>" class="btn btn-sm btn-clean btn-icon" title="view"><i class="la la-eye"></i>	</a>
											  	</td>
				...
				<div class="d-flex align-items-center mt-5">
					...
					<div class="d-flex flex-column">
						...
						<div class="navi mt-2">
							...
							<a href="<?=base_url()?>admin/signout" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Sign Out</a>
						</div>
					</div>
				</div>
