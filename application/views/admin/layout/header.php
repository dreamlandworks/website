										...
										<form>
											...
											<div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url(<?=base_url()?>assets/media/misc/bg-1.jpg)">
												...
												<h4 class="d-flex flex-center rounded-top">
													...
													<span class="btn btn-text btn-success btn-sm font-weight-bold btn-font-md ml-2"><?php date_default_timezone_set('Asia/Kolkata'); 
     												 $date= date("Y-m-d");
  													$comparefirst = date('Y-m-d', strtotime($date."-7 day"));
   														echo $this->db->where('created_date>=',$comparefirst)->from("notification")->count_all_results();?> new</span>
												</h4>
												<!--end::Title-->
												<!--begin::Tabs-->
													...
													<div class="scroll pr-7 mr-n7" data-scroll="true" data-height="300" data-mobile-height="200">
														...
														<div class="d-flex align-items-center mb-6">
															...
															<div class="d-flex flex-column font-weight-bold">
                                                             		<?php if($Notification){ foreach($Notification as $Notification){ ?>					
                                                                 <div class="navi-icon mr-2">
            																	<i class="flaticon2-user flaticon2-line- text-success"></i>
            																
																<!-- <a href="#" class="text-dark-75 text-hover-primary mb-1 font-size-lg"> Notification</a> -->
																
																<span class="text-muted">
																	<?=ucwords($Notification->message).'  &nbsp; &nbsp;  ' .$Notification->created_date."</br>";?>

																</span>
																
																	<!-- <span class="text-muted"><?=$Notification->created_date."</br>";?></span> -->
