...
<head>
		...
		<meta charset="utf-8" />
		<title>Pending Job  | Satarango </title>
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<!--begin::Page Title-->
										<h5 class="text-dark font-weight-bold my-1 mr-5">Pending Jobs</h5>
										<!--end::Page Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item">
												<a href="#" class="text-muted">Pending Jobs</a>
											</li>
											<li class="breadcrumb-item">
												<a href="#" class="text-muted">Pending Jobs  List</a>
											</li>
								...
								<div class="card card-custom">
									<div class="card-header">
										<div class="card-title">
											...
											<h3 class="card-label">Pending Job  list</h3>
										</div>
												...
												<tr>
													...
													<td>	<div class="dropdown dropdown-inline">
													    	<div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
													    	 ...
													    	 <a onclick="return confirm('Are you sure want to delete ?');"  href="<?=base_url('Admin/pendingdelete')?>/<?=$pending_job->id?>" class="btn btn-sm btn-clean btn-icon" title="Delete"><i class="la la-trash"></i>	</a>
													    	<a href="<?=base_url('Admin/pendingdetails')?>/<?=$pending_job->id?>" class="btn btn-sm btn-clean btn-icon" title="view"><i class="la la-eye"></i>	</a>
											  	</td>
