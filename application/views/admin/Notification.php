...
<head>
		...
		<title> Notification List | Satarango </title>
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									...
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										...
										<h5 class="text-dark font-weight-bold my-1 mr-5">Notification</h5>
										...
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											...
											<li class="breadcrumb-item">
												...
												<a href="#" class="text-muted">Notification</a>

											</li>

											<li class="breadcrumb-item">

												<a href="#" class="text-muted">Notification List</a>
                       ...
                       <form action="<?=base_url('admin/reports')?>"  method="post" >        
                          <div class="row">
                            ...
                            <div class="col-md-3">
                              ...
                              <input type="text" name="search" class="form-control" placeholder="Enter Keyword Subject">
                            </div>
                            <div class="col-md-3 ">
                               
                              <button type="submit" class="btn-primary btn " style="margin-top: 24px;">Search</button>
                            </div>
                          </div>
                        </form>  
                        </div>
									...
									<?php if($Notifications){ foreach($Notifications as $user){ ?>

												<tr>

												 

													<td style="width : 175px"> <?=$user->type?></td>

												

												    <td style="width : 180px"><?=$user->subject?></td>

													<td style="width : 180px"><?=$user->message?></td>	
													<td style="width : 180px"><?=$user->date?></td>
