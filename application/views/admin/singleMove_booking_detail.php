...
<head>
		...
		<title>Booking Details | Satarango </title>
							...
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								<div class="d-flex align-items-center flex-wrap mr-1">
									<div class="d-flex align-items-baseline flex-wrap mr-5">
										<h5 class="text-dark font-weight-bold my-1 mr-5">Active Details</h5>
										<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
											<li class="breadcrumb-item">
												<a href="#" class="text-muted">Application</a>
											</li>
											<li class="breadcrumb-item">
												<a href="#" class="text-muted">Booking details</a>
											</li>
										</ul>
								...
								<div class="row"> 
									...
									<div class=" card col-lg-12">
									 ...
									 <div class="card-body ">
									   ...
									   <input type="text" class="form-control form-control-solid"   value="<?=$details->v_name?>" />
									   ...
									   <input type="text" class="form-control form-control-solid"   value="<?=$details->from_time?>" />
									   ...
									   <input type="text" class="form-control form-control-solid"   value="<?=$details->to_time?>" />
									  ...
									  <div class="form-group" style="width: 400px;">
									   ...
									   <input type="text" class="form-control form-control-solid"   value="<?=$details->work_description?>" />
									  ...
									  <div class="form-group" style="width: 400px;">
									   ...
									   <input type="text" class="form-control form-control-solid"   value="<?=$details->start_location1?>" />
									  ...
									  <div class="form-group" style="width: 400px;">
									   ...
									   <input type="text" class="form-control form-control-solid"   value="<?=$details->end_location1?>" desible="" />
									  ...
									  <div class="form-group" style="width: 400px;">
									   ...
									   <input type="text" class="form-control form-control-solid" value="<?=$details->job_estimate?>">
