...
<!-- Mirrored from codeminifier.com/new-jobvivo-demo/jobvivo/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 10 Dec 2020 06:31:06 GMT -->
<head>
	...
	<body class="blue-skin">
			...
			<div class="container">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="index-2.html">
						<img src="<?php echo base_url()?>assets/img/logo-light.png" class="logo logo-display" alt="">
						<img src="<?php echo base_url()?>assets/img/logo.png" class="logo logo-scrolled" alt="">
					</a>
				...
				<div class="collapse navbar-collapse" id="navbar-menu">
					...
					<ul class="nav navbar-nav navbar-left" data-in="fadeInDown" data-out="fadeOutUp">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu animated fadeOutUp">
								...
								<li><a href="home-4.html">Home 4</a></li><li><a href="home-5.html">Home 5</a></li><li><a href="home-6.html">Home 6</a></li><li><a href="home-7.html">Home 7</a></li><li><a href="home-8.html">Home 8</a></li>
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="sign-up"><a class="btn-signup red-btn" href="signup.html"><span class="ti-briefcase"></span>Sign Up</a></li> 
					</ul>
		...
		<!-- ======================= Start Banner ===================== -->
		<div class="main-banner" style="background-image:url(<?php echo base_url()?>assets/img/banner-1.jpg);" data-overlay="8">
			<div class="container">
							...
							<div class="col-lg-3 col-md-4 col-sm-6">
								<div class="grid-job-widget">
									...
									<div class="u-content">
										<div class="avatar box-80">
											<a href="employer-detail.html">
												<img class="img-responsive" src="<?php echo base_url()?>assets/img/c-5.png" alt="">
											</a>
										</div>
							...
							<div class="col-lg-3 col-md-4 col-sm-6">
								<div class="grid-job-widget">
									...
									<div class="u-content">
										<div class="avatar box-80">
											<a href="employer-detail.html">
												<img class="img-responsive" src="<?php echo base_url()?>assets/img/c-6.png" alt="">
											</a>
										</div>
							...
							<div class="col-lg-3 col-md-4 col-sm-6">
								<div class="grid-job-widget">
									...
									<div class="u-content">
										<div class="avatar box-80">
											<a href="employer-detail.html">
												<img class="img-responsive" src="<?php echo base_url()?>assets/img/c-7.png" alt="">
											</a>
										</div>
							...
							<div class="col-lg-3 col-md-4 col-sm-6">
								<div class="grid-job-widget">
									...
									<div class="u-content">
										<div class="avatar box-80">
											<a href="employer-detail.html">
												<img class="img-responsive" src="<?php echo base_url()?>assets/img/c-8.png" alt="">
											</a>
										</div>
		...
		<!-- ================= Category start ========================= -->
		<section class="image-bg" style="background:url(<?php echo base_url()?>assets/img/banner-2.jpg) no-repeat;" data-overlay="7">
			<div class="container">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-10 col-md-offset-1">
						<div class="heading">
							<h2>Choose <span class="theme-cl">Packages</span></h2>
		...
		<!-- =================== Newsletter ==================== -->
		<section class="newsletter theme-bg" style="background-image:url(<?php echo base_url()?>assets/img/bg-new.png)">
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="copyright text-center">
							<p>&copy; Copyright 2018 Jobvivo | Powerd By <a href="http://themezhub.com/" title="Themez Hub">Themez Hub</a></p>
						</div>
					</div>
				</div>
			...
			<div class="modal-dialog">
				<div class="modal-content" id="myModalLabel1">
					<div class="modal-body">
						<div class="text-center"><img src="<?php echo base_url()?>assets/img/logo.png" alt="" class="img-responsive"></div>
		...
		<div class="style-switcher">
			...
			<div>
				<ul id="themecolors" class="m-t-20">
					<li><a href="javascript:void(0)" data-skin="red-skin" class="red-theme">1</a></li>
...
<!-- Mirrored from codeminifier.com/new-jobvivo-demo/jobvivo/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 10 Dec 2020 06:31:30 GMT -->
</html>