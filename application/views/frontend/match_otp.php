       ...
       <div class="container">
          ...
          <div class="row">
                        ...
                        <div style="margin-top:80px;" class="col-xs-6 col-sm-6 col-md-6 login-box">
                                ...
                                <form  id="match-otp" action="" method="post" onsubmit="return false;">
                          <div class="form-group">
                            <div class="input-group">
                              <div class="input-group-addon"></div>
                              <input class="form-control" type="text" name="otp" id="otp" placeholder="Enter the Otp">
                            </div>
                          </div>
                          
                          <div class="">
                    <button type="submit" id="load" class="btn theme-btn btn-m">Submit</button>
                </div>
                        </form>
                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
      $('#match-otp').validate({ 
          ...
          {
              $.ajax({
                  url: "<?= base_url(); ?>LoginRegistration/verify_otp", 
                  type: "POST",             
                  data: $(form).serialize(),
                  cache: false,             
                  processData: false, 
                  ...
                  success: function(data) 
                  {
                    if(data.result){
                      ...
                      setTimeout(function(){ 
                        window.location.href = "<?php echo base_url('Home/set_password/') ?>"+data.id;
                      }, 1000);
                    }else{
