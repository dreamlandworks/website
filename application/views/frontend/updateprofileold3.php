       ...
       <?php if ($counter == 0):
                  $counter++; ?>
							...
							<select name="day_type[]" class="wide form-control selectpicker">
                                ...
                                <select name="day_name[<?php echo $i; ?>][]" class="wide form-control selectpicker" id="multi-select-demo" multiple="multiple" >
              ...
              <select name="day_type[]" class="wide form-control " id="actions">
                ...
                <div class="col-sm-3">
                  <label>Day Name</label>
                         ...
                         <select name="day_name[$i][]" class="form-control " id="multi-select-demo" multiple="multiple" id="actions" >
                      <option  disabled="" value="">You can select  Days  *</option>
