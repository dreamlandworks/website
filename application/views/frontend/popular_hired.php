            ...
            <div class="row">
             <?php foreach($popular AS $row):?>
              ...
              <div class="col-lg-3 col-md-3 col-sm-6">
                  ...
                  <a href="#">
                        <img class="img-responsive" src="<?php echo base_url()?>assets/media/users/<?=$row->vendor_image;?>" alt="" style="height: 200px; width: 185px;">
                    </a>
                </div>
                <h5><a href="#"><?=$row->vendor_name;?></a></h5>
                  
                      <div class="">
                                        <span style="color: #FFD700; font-size:25px;" class="<?php if ($row->rating >= 1) {
                                            echo 'fa fa-star';
                                            }else{ echo 'fa fa-star-o';} ?>"></span>
                                            <span style="color: #FFD700;font-size:25px;" class="<?php if ($row->rating >=2) {
                                            echo 'fa fa-star';
                                            }else{ echo 'fa fa-star-o'; } ?>" ></span>
                                            <span style="color: #FFD700;font-size:25px;" class="<?php if ($row->rating >=3) {
                                            echo 'fa fa-star';
                                            }else{ echo 'fa fa-star-o';} ?>"></span>
                                            <span style="color: #FFD700;font-size:25px;" class="<?php if ($row->rating >=4) {
                                            echo 'fa fa-star';
                                            }else{ echo 'fa fa-star-o'; } ?>" ></span>
                                            <span style="color: #FFD700;font-size:25px;" class="<?php if ($row->rating >=5) {
                                            echo 'fa fa-star';
