...
<section>
      <div class="container">
        ...
        <div class="panel panel-default ">
            <div class="panel-heading accordion-toggle question-toggle collapsed" data-toggle="collapse" data-parent="#faqAccordion" data-target="#question<?php echo $row->id; ?>">
                 <h4 class="panel-title">
                    <a href="#" class="ing">Q: <?php echo $row->question;?>?</a>
              </h4>

            </div>
            <div id="question<?php echo $row->id; ?>" class="panel-collapse collapse" style="height: 0px;">
