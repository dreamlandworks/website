						...
						<div class="box-body">
							<div class="row">
								...
								<div class="col-sm-3">
									...
									<input type="text" class="form-control" name="pr_hours" value="<?php echo $user_tarif['pr_hours'] ;?>" required>
								</div>
								
								<div class="col-sm-3">
									<label>Per Day</label>
									<input type="text" class="form-control" name="pr_days" value="<?php echo $user_tarif['pr_days'] ;?>" required>
								</div>
								
								<div class="col-sm-3">
									<label>Minimum Charge</label>
									<input type="text" class="form-control" name="min_charge" value="<?php echo $user_tarif['min_charge'] ;?>" required>
								</div>
								
								<div class="col-sm-3">
									<label>Extra Charge</label>
									<input type="text" class="form-control" name="extra_charge" value="<?php echo $user_tarif['extra_charge'] ;?>" required>
								</div>
						...
						<div class="box-body">
							<div class="row">
								...
								<div class="col-sm-3">
									...
									<input type="time" class="form-control" name="from_time" value="<?php echo $user_tarif['from_time'] ;?>" required>
								</div>
								
								<div class="col-sm-3">
									<label>To Time</label>
									<input type="time" class="form-control" name="to_time" value="<?php echo $user_tarif['to_time'] ;?>" required>
								</div>
							...
							<select name="day_type" class="wide form-control selectpicker">
								...
								<option <?php if($user_tarif['day_type']=="Everyday"): echo " selected " ; endif ?>   value="Everyday">Everyday</option>
                                          <option <?php if($user_tarif['day_type']=="Week-days"): echo " selected " ; endif ?> value="Week-days">Week-days</option>
                                          <option <?php if($user_tarif['day_type']=="Week-ends"): echo " selected " ; endif ?> value="Week-ends">Week-ends</option>
                                      </select> 
								</div>
								
								<div class="col-sm-3">
									<label>Day Name</label>
								<?php $exp=explode(",",$user_tarif['day_name']); ?>
